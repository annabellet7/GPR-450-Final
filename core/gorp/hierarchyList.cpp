...
void HierarchyList::poseLerp(int keyframeIndex0, int keyframeIndex1, int numNodes, float t)
{
	...
	{
		//NodeTransforms transform0, transform1;
		//for (int j = 0; j < nodePoseList->transformsList.size(); j++)
		//{
		//	if (nodePoseList->transformsList[j].nodeIndex == i && nodePoseList->transformsList[j].keyframeIndex == keyframeIndex0)
		//	{
		//		transform0.local = nodePoseList->transformsList[j].local;
		//	}
		//	if (nodePoseList->transformsList[j].nodeIndex == i && nodePoseList->transformsList[j].keyframeIndex == keyframeIndex1)
		//	{
		//		transform1.local = nodePoseList->transformsList[j].local;
		//	}
		//}
